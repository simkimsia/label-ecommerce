<div class="productsInGroups index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $productsInGroup['ProductsInGroup']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $productsInGroup['ProductsInGroup']['id']), null, __('Are you sure you want to delete # %s?', $productsInGroup['ProductsInGroup']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
