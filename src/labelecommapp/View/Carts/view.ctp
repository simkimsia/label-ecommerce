...
<div id="u15_rtf"><p style="text-align:left;"><span style="font-family:Helvetica;font-size:18px;font-weight:bold;font-style:normal;text-decoration:none;color:#404040;">Product name</span></p></div>
</div>
...
<div id="u19_rtf"><p style="text-align:left;"><span style="font-family:Helvetica;font-size:15px;font-weight:bold;font-style:normal;text-decoration:none;color:#333333;">$399.00</span></p></div>
</div>
...
<INPUT id="u21" type=text value="1" class="u21"     >
...
<div id="u25_rtf"><p style="text-align:left;"><span style="font-family:Helvetica;font-size:15px;font-weight:bold;font-style:normal;text-decoration:none;color:#333333;">$399.00</span></p></div>
</div>
...
<div id="u29_rtf"><p style="text-align:left;"><span style="font-family:Helvetica;font-size:15px;font-weight:bold;font-style:normal;text-decoration:none;color:#333333;">$399.00</span></p></div>
</div>
...
<div id="u37_rtf"><p style="text-align:left;"><span style="font-family:Helvetica;font-size:20px;font-weight:bold;font-style:normal;text-decoration:none;color:#FFFFFF;">$418.00</span></p></div>
</div>
...
<div class="preload"><?php echo $this->Html->image('cart_step_1/u0_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u0_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u2_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u2_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u5_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u5_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u7_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u7_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u9_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u9_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u11_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u11_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u26_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u26_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u34_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u34_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u38_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u38_normal.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u41_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u41_line.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u43_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u43_line.png" width="1" height="1"/> -->
	<?php echo $this->Html->image('cart_step_1/u44_normal.png', array('width' => '1', 'height' => '1'));?>
	<!-- <img src="Classic_Step_1_files/u44_normal.png" width="1" height="1"/></div> -->
